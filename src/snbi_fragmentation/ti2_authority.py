...
BOUNDARY_STATE = {
    ...
    "blocked_phases": ["TI-2", "TI-2R", *[f"TI-{phase}" for phase in range(3, 9)]],
}
...
def audit_authority(root: Path = ROOT) -> dict:
    ...
    return {
        ...
        "codex_local_write_readiness": CLOSED_STATE["codex_local_write_readiness"],
        "merge_authorized": False,
        "blocked_phases": list(BOUNDARY_STATE["blocked_phases"]),
