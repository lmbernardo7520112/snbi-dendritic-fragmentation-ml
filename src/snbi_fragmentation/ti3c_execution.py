"""TI3-C receipt and exact paired TRAIN/DEV I/O; no array processing or fitting.

TI3-A/B consumed authority is never rearmed. All FINAL records are textual
...
BASE = "artifacts/evidence/TI3_C_CNN"
...
def arm_execution(root, manifest_bytes, inventory, authority, head):
    """Consume a new exclusive receipt after the caller's C1-CNN/CI preflight."""
    ...
    require(digest_string(head, 40) and authority.get("head_sha") == head, "C1_HEAD_MISMATCH")
    ...
    try:
        ...
        receipt = {"schema": "TI3C-EXECUTION-RECEIPT-1", "state": "CONSUMED_BEFORE_NATIVE_BYTES",
...
class NativeReader:
    ...
    def report(self):
        ...
        result = {"schema": "TI3C-NATIVE-IO-AUDIT-1", "receipt_invocations": 1,
