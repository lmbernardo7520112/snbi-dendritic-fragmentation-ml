"""Strict SOLUTE DIRECT contracts on synthetic memory only, never experimental IO."""
...
def main():
    ...
    suite = unittest.defaultTestLoader.loadTestsFromName("tests.test_ti2r_solute_direct_registration")
    count = suite.countTestCases()
    if count != 27:
        raise RuntimeError("SOLUTE DIRECT synthetic contract set incomplete")
