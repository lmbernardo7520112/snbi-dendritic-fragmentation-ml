"""Strict DIRECT contracts on synthetic memory only, never experimental IO."""
...
def main():
    ...
    suite = unittest.defaultTestLoader.loadTestsFromName("tests.test_ti2r_frag_direct_registration")
    count = suite.countTestCases()
    if count != 26:
        raise RuntimeError("DIRECT synthetic contract set incomplete")
